    ...
    <div className="p-6 md:p-8 space-y-10 animate-fade-in pb-24">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4 mt-2">
             <p className="text-[var(--text-muted)] text-[11px] max-w-sm leading-relaxed opacity-70">
               Gestão e configuração de portfólio: identidade, ficha técnica, workflows e precificação.
             </p>
             <button 
               onClick={async () => {
               ...
               className="flex items-center gap-2 px-3 py-1.5 bg-[var(--accent-start)]/5 border border-[var(--accent-start)]/20 rounded-lg hover:bg-[var(--accent-start)] hover:text-white transition-all text-[8px] font-bold uppercase tracking-widest text-[var(--accent-start)]"
             >
                <Database size={10} />
                Seed Initial Data
             </button>
        ...
        <Link 
          ...
          className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--text-primary)] text-[var(--bg-primary)] rounded-full text-[9px] font-bold uppercase tracking-widest hover:translate-y-[-2px] shadow-xl transition-all"
        >
          <Plus size={16} />
          Criar Novo Produto
        </Link>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between px-4">
          <h2 className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-muted)] opacity-60">Portfólio de Serviços</h2>
...
function StatCard({ label, value, icon }: any) {
  return (
    <div className="p-7 bg-[var(--input-bg)] border border-[var(--border-primary)] rounded-[2rem] flex items-center justify-between group hover:border-[var(--accent-start)]/30 transition-all">
      ...
      <div className="p-4 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border-primary)] text-[var(--text-muted)] group-hover:text-[var(--accent-start)] transition-colors">
        {icon}
      </div>
    </div>
  );
...
function ProductItem({ product }: { product: Product }) {
  return (
    <div className="p-5 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-[1.5rem] flex items-center justify-between group transition-all">
      ...
      <div className="flex items-center gap-3">
        <Link 
          ...
          className="p-3 rounded-xl border border-[var(--border-primary)] text-[var(--text-muted)] hover:text-[var(--accent-start)] hover:border-[var(--accent-start)]/30 transition-all"
        >
          <Settings size={16} />
        </Link>
        <Link 
