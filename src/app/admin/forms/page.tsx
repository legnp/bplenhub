  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-10 text-center border-2 border-dashed border-[var(--border-primary)] rounded-2xl bg-[var(--input-bg)] backdrop-blur-sm mt-8">
        <p className="text-sm text-[var(--text-muted)] opacity-60 font-medium font-bold uppercase tracking-widest">Módulo em construção: Tabela de Formulários (Showrooms/Landing Page) inserida aqui.</p>
      </div>
    </div>
  );
}
